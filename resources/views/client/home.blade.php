                            ...
                            <div class="tab-pane fade show active" id="tab1">
                                <div class="product-carousel-4 slick-row-10 slick-arrow-style">
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('assets/client/img/product/product-2.jpg') }}"
                                                    alt="product">
                                                <img class="sec-img" src="{{ asset('assets/client/img/product/product-17.jpg') }}"
                                                    alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('assets/client/img/product/product-3.jpg') }}"
                                                    alt="product">
                                                <img class="sec-img" src="{{ asset('assets/client/img/product/product-16.jpg') }}"
                                                    alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('assets/client/img/product/product-4.jpg') }}"
                                                    alt="product">
                                                <img class="sec-img" src="{{ asset('assets/client/img/product/product-15.jpg') }}"
                                                    alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('assets/client/img/product/product-5.jpg') }}"
                                                    alt="product">
                                                <img class="sec-img" src="{{ asset('assets/client/img/product/product-14.jpg') }}"
                                                    alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                            ...
                            <div class="tab-pane fade" id="tab2">
                                <div class="product-carousel-4 slick-row-10 slick-arrow-style">
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('assets/client/img/product/product-6.jpg') }}"
                                                    alt="product">
                                                <img class="sec-img" src="{{ asset('assets/client/img/product/product-13.jpg') }}"
                                                    alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('assets/client/img/product/product-7.jpg') }}"
                                                    alt="product">
                                                <img class="sec-img" src="{{ asset('assets/client/img/product/product-12.jpg') }}"
                                                    alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('assets/client/img/product/product-8.jpg') }}"
                                                    alt="product">
                                                <img class="sec-img" src="{{ asset('assets/client/img/product/product-11.jpg') }}"
                                                    alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('assets/client/img/product/product-9.jpg') }}"
                                                    alt="product">
                                                <img class="sec-img" src="{{ asset('assets/client/img/product/product-10.jpg') }}"
                                                    alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('assets/client/img/product/product-10.jpg') }}"
                                                    alt="product">
                                                <img class="sec-img" src="{{ asset('assets/client/img/product/product-9.jpg') }}"
                                                    alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                            ...
                            <div class="tab-pane fade" id="tab4">
                                <div class="product-carousel-4 slick-row-10 slick-arrow-style">
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('assets/client/img/product/product-16.jpg') }}"
                                                    alt="product">
                                                <img class="sec-img" src="{{ asset('assets/client/img/product/product-3.jpg') }}"
                                                    alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('assets/client/img/product/product-17.jpg') }}"
                                                    alt="product">
                                                <img class="sec-img" src="{{ asset('assets/client/img/product/product-2.jpg') }}"
                                                    alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('assets/client/img/product/product-18.jpg') }}"
                                                    alt="product">
                                                <img class="sec-img" src="{{ asset('assets/client/img/product/product-1.jpg') }}"
                                                    alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
